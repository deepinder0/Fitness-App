...
class Profile3 extends Component {
  ...
  state = {
    tabs: {
      index: 0,
      routes: [
        { key: "1", title: "PHOTOS", count: 12 },
        { key: "2", title: "FOLLOWING", count: 405 },
          ...
          <View style={styles.upperProfileView}>
            <View style={styles.profileFeildsContainer}>
              <View style={styles.profileFeildLeftContainer}>
                ...
                <Text style={styles.profileBio}>@{username}</Text>
  ...
  render() {
    return (
      <View style={{ display: "flex", flex: 1, backgroundColor: "black" }}>
        <View style={{ display: "flex", flex: 1, marginTop: windowWidth / 15 }}>
